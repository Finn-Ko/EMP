...
export default class PythonLang {
    constructor() {
        this.dictionary = new Map([
            ...
            ["IndentationError", new Hint("".concat("Your indentation is wrong somewhere.\n"), "".concat("Deine Einrückung ist falsch.\n", "indentation (En) = Einrückung (De)"))],
